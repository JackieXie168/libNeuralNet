...
public:
   ...
   void test_get_template_filename(void);
   void test_get_input_filename(void);

   void test_get_script_filename(void);

   void test_get_output_filename(void);
   ...
   void test_set_template_filename(void);
   void test_set_input_filename(void);

   void test_set_script_filename(void);

   void test_set_output_filename(void);
