...
public:
   ...
   void test_get_parameters_scaling_flag(void);
   ...
   void test_get_parameters_bounds_flag(void);
  ...
  // Display messages
   ...
   void test_set_parameters_scaling_flag(void);
   ...
   void test_set_parameters_bounds_flag(void);
