...
/*
   try
   {
      ...
      independent_parameters_pointer->initialize_parameters_uniform(-500.0, 500.0);
      ...
      training_strategy.set_initialization_training_algorithm_type(TrainingStrategy::EVOLUTIONARY_ALGORITHM);

      training_strategy.set_main_training_algorithm_type(TrainingStrategy::QUASI_NEWTON_METHOD);
      ...
      neural_network.save("../data/schwefel_function/neural_network.xml");

      training_strategy.save("../data/schwefel_function/training_strategy.xml");
      
      training_strategy_results.save("../data/schwefel_function/training_strategy_results.dat");
