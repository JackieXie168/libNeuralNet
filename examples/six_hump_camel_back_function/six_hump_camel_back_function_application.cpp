...
/*
   try
   {
      ...
      independent_parameters_pointer->initialize_parameters_uniform(independent_parameters_minimum, independent_parameters_maximum);
	  ...
	  performance_functional.set_objective_term_pointer(six_hump_camel_back_function);
