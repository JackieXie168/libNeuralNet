...
/*
   try
   {
      ...
      independent_parameters_pointer->initialize_parameters_uniform(-2.048, 2.048);
      ...
      performance_functional.set_objective_term_type(PerformanceFunctional::USER_PERFORMANCE_TERM);

      RosenbrockFunction* rf = new RosenbrockFunction(&neural_network);

      performance_functional.set_objective_term_pointer(rf);  
      ...
      double performance = performance_functional.calculate_evaluation();
      ...
      neural_network.save("../data/rosenbrock_function/neural_network.xml");

      training_strategy.save("../data/rosenbrock_function/training_strategy.xml");
