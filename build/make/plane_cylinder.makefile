...
plane.cpp \
cylinder.cpp \
plane_cylinder_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/plane_cylinder.exe
...
all:
	$(MAKE) -f plane_cylinder.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f plane_cylinder.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f plane_cylinder.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f plane_cylinder.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
