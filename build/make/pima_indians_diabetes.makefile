...
#                                                                                                                #
#   P I M A   I N D I A N S   D I A B E T E S   M A K E F I L E                                                  #
#                                                                                                                #
...
SOURCE_FILES =  \
pima_indians_diabetes_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/pima_indians_diabetes.exe
...
all:
	$(MAKE) -f pima_indians_diabetes.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f pima_indians_diabetes.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f pima_indians_diabetes.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f pima_indians_diabetes.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
