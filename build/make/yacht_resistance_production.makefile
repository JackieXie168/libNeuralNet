...
#                                                                                                                #
#   Y A C H T   R E S I S T A N C E   P R O D U C T I O N   M A K E F I L E                                      #
#                                                                                                                #
...
SOURCE_FILES =  \
yacht_resistance_production_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/yacht_resistance_production.exe
...
all:
	$(MAKE) -f yacht_resistance_production.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f yacht_resistance_production.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel )
	$(MAKE) -f yacht_resistance_production.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f yacht_resistance_production.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
