...
#                                                                                                                #
#   L O G I C A L   O P E R A T I O N S   M A K E F I L E                                                        #
#                                                                                                                #
...
SOURCE_FILES =  \
logical_operations_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/logical_operations.exe
...
all:
	$(MAKE) -f logical_operations.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f logical_operations.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f logical_operations.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f logical_operations.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
