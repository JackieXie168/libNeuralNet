...
#                                                                                                                #
#   I S O P E R I M E T R I C   P R O B L E M   M A K E F I L E                                                  #
#                                                                                                                #
...
area.cpp \
perimeter.cpp \
isoperimetric_problem_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/isoperimetric_problem.exe
...
all:
	$(MAKE) -f isoperimetric_problem.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f isoperimetric_problem.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f isoperimetric_problem.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f isoperimetric_problem.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
