...
#                                                                                                                #
#   I R I S   P L A N T   M A K E F I L E                                                                        #
#                                                                                                                #
...
EXE_NAME = $(OBJECTS_DIR)/iris_plant.exe
...
all:
	$(MAKE) -f iris_plant.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f iris_plant.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f iris_plant.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f iris_plant.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
