...
#                                                                                                                #
#   P R E C I P I T A T E   D I S S O L U T I O N   M O D E L I N G   M A K E F I L E                            #
#                                                                                                                #
...
SOURCE_DIRS = \
precipitate_dissolution_modeling
...
precipitate_dissolution_modeling_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/precipitate_dissolution_modeling.exe
...
all:
	$(MAKE) -f precipitate_dissolution_modeling.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f precipitate_dissolution_modeling.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f precipitate_dissolution_modeling.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f precipitate_dissolution_modeling.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
