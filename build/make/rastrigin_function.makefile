...
rastrigin_function_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/rastrigin_function.exe
...
all:
	$(MAKE) -f rastrigin_function.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f rastrigin_function.makefile exe

rel:
	+(make -f tinyxml.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f rastrigin_function.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f rastrigin_function.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
