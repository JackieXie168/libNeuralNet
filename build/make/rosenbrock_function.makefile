...
rosenbrock_function_application.cpp 
...
EXE_NAME = $(OBJECTS_DIR)/rosenbrock_function.exe
...
all:
	$(MAKE) -f rosenbrock_function.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f rosenbrock_function.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f rosenbrock_function.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f rosenbrock_function.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
