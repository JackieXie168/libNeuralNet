...
#                                                                                                                #
#   C A R   P R O B L E M   M A K E F I L E                                                                      #
#                                                                                                                #
...
EXE_NAME = $(OBJECTS_DIR)/car_problem.exe
...
all:
	$(MAKE) -f car_problem.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f car_problem.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f car_problem.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f car_problem.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
