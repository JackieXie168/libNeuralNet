...
#                                                                                                                #
#   A I R F O I L   S E L F - N O I S E   M A K E F I L E                                                        #
#                                                                                                                #
...
SOURCE_DIRS =  airfoil_self_noise
...
SOURCE_FILES =  airfoil_self_noise_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/airfoil_self_noise.exe
...
all:
	$(MAKE) -f airfoil_self_noise.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f airfoil_self_noise.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel )
	$(MAKE) -f airfoil_self_noise.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f airfoil_self_noise.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
