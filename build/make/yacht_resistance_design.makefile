...
SOURCE_FILES =  \
yacht_resistance_design_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/yacht_resistance_design.exe
...
all:
	$(MAKE) -f yacht_resistance_design.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f yacht_resistance_design.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f yacht_resistance_design.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f yacht_resistance_design.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
