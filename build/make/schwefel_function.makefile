...
#                                                                                                                #
#   S C H W E F E L   F U N C T I O N   M A K E F I L E                                                          #
#                                                                                                                #
...
schwefel_function_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/schwefel_function.exe
...
all:
	$(MAKE) -f schwefel_function.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f schwefel_function.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f schwefel_function.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f schwefel_function.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
