...
#                                                                                                                #
#   E A S O M   F U N C T I O N   M A K E F I L E                                                                #
#                                                                                                                #
...
SOURCE_FILES =  \
easom_function.cpp \
easom_function_application.cpp \
...
EXE_NAME = $(OBJECTS_DIR)/easom_function.exe
...
all:
	$(MAKE) -f easom_function.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f easom_function.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f opennn.makefile rel)
	$(MAKE) -f easom_function.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f easom_function.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
