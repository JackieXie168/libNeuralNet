...
#                                                                                                                #
#   F E D   B A T C H   F E R M E N T E R   M A K E F I L E                                                      #
#                                                                                                                #
...
fed_batch_fermenter_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/fed_batch_fermenter.exe
...
all:
	$(MAKE) -f fed_batch_fermenter.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f fed_batch_fermenter.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f fed_batch_fermenter.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f fed_batch_fermenter.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
