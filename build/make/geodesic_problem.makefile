...
#                                                                                                                #
#   G E O D E S I C   P R O B L E M   M A K E F I L E                                                            #
#                                                                                                                #
...
SOURCE_FILES =  \
arc_length.cpp \
geodesic_problem_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/geodesic_problem.exe
...
all:
	$(MAKE) -f geodesic_problem.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f geodesic_problem.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f geodesic_problem.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f geodesic_problem.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
