...
#                                                                                                                #
#   B R A C H I S T O C H R O N E   P R O B L E M   M A K E F I L E                                              #
#                                                                                                                #
...
SOURCE_DIRS = brachistochrone_problem
...
SOURCE_FILES =  \
descent_time.cpp \
brachistochrone_problem_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/brachistochrone_problem.exe
...
all:
	$(MAKE) -f brachistochrone_problem.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f brachistochrone_problem.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f brachistochrone_problem.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f brachistochrone_problem.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
