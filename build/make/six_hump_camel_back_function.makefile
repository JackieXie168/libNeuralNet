...
#                                                                                                                #
#   S I X   H U M P   C A M E L   B A C K   F U N C T I O N   M A K E F I L E                                    #
#                                                                                                                #
...
six_hump_camel_back_function_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/six_hump_camel_back_function.exe
...
all:
	$(MAKE) -f six_hump_camel_back_function.makefile deb

deb:
	+( make -f tinyxml.makefile)
	+( make -f opennn.makefile)
	$(MAKE) -f six_hump_camel_back_function.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f six_hump_camel_back_function.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f six_hump_camel_back_function.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
