...
aircraft_landing_application.cpp
...
EXE_NAME = $(OBJECTS_DIR)/aircraft_landing.exe
...
all:
	$(MAKE) -f aircraft_landing.makefile deb

deb:
	+(make -f tinyxml.makefile)
	+(make -f opennn.makefile)
	$(MAKE) -f aircraft_landing.makefile exe

rel:
	+(make -f opennn.makefile rel)
	+(make -f tinyxml.makefile rel)
	$(MAKE) -f aircraft_landing.makefile exe "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
...
clean:
	...
	$(MAKE) -f aircraft_landing.makefile clean_rel "FLAGS=$(FLAGS_O)" "DESTINATION_DIR=release"
